...
namespace arcade
{
  ...
  class IGraphic
  {
    public:
      ...
      virtual void				ShowMenu(std::vector<std::string>, int, std::vector<std::string>, int, arcade::Player) = 0;
      virtual void				ShowScoreboard(std::string &, std::vector<arcade::Score>) = 0;
